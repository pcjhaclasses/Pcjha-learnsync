          ...
          <div className="space-y-2 pt-2 border-t border-stone-100 dark:border-stone-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="p-2.5 rounded-lg bg-stone-50 dark:bg-stone-800/60 border border-stone-100 dark:border-stone-800">
                <span className="font-semibold text-stone-800 dark:text-stone-200 block mb-0.5">Left Click Content</span>
                <span className="text-stone-500 text-[11px]">Advances to next word</span>
              </div>
              <div className="p-2.5 rounded-lg bg-stone-50 dark:bg-stone-800/60 border border-stone-100 dark:border-stone-800">
                <span className="font-semibold text-stone-800 dark:text-stone-200 block mb-0.5">Right Click Content</span>
